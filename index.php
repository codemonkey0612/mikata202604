    ...
    <div class="form_card">
      ...
      <form id="rc_form_y" name="contact_y" method="post" action="./confirm_y.php" class="form_panel<?php echo ($tab === 'y') ? ' is_active' : ''; ?>" novalidate>
        ...
        <div class="form_row<?php echo !empty($err_y['y_zip']) ? ' is_error' : ''; ?>">
          ...
          <input class="form_input form_input_zip" type="text" name="y_zip" value="<?php echo h(isset($y['y_zip']) ? $y['y_zip'] : ''); ?>" placeholder="例：1030006（ハイフンなし）" onKeyUp="AjaxZip3.zip2addr(this,'','y_pref','y_address01');">
