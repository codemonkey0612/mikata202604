...
$err = validate_y($in);
if (!empty($err)) {
    $_SESSION['lp_m06_request_y'] = $in;
    $_SESSION['lp_m06_err_y']     = $err;
    $_SESSION['lp_m06_Tabflag']   = 'y';
    ...
    <div class="confirm_sec_inner">
      ...
      <div class="confirm_sec_card">
        <dl class="confirm_sec_list">
          <dt>お名前</dt>
          <dd><?php echo h($in['y_name']); ?></dd>

          <dt>フリガナ</dt>
          <dd><?php echo h($in['y_kana']); ?></dd>

          <dt>メールアドレス</dt>
          <dd><?php echo h($in['y_mail']); ?></dd>

          <dt>電話番号</dt>
          <dd><?php echo h($in['y_tel']); ?></dd>

          <dt>郵便番号</dt>
          <dd><?php echo h($in['y_zip']); ?></dd>

          <dt>都道府県</dt>
          <dd><?php echo h($in['y_pref']); ?></dd>

          <dt>住所</dt>
          <dd><?php echo h($in['y_address01']); ?></dd>

          <dt>番地・建物名</dt>
          <dd><?php echo h($in['y_address02']); ?></dd>
        </dl>
      </div>
      ...
      <div class="confirm_sec_buttons">
        ...
        <div class="confirm_sec_submit_form">
          <form method="post" action="./sendmail_y.php">
