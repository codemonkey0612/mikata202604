...
unset($_SESSION['lp_m06_request_y'], $_SESSION['lp_m06_Tabflag']);
?>
<!DOCTYPE html>
<html lang="ja">
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# website: http://ogp.me/ns/website#">
  ...
  <title>郵送申込完了｜<?php echo h(PAGE_TITLE); ?></title>
...
<main>
  <section class="thanks_sec">
    <div class="thanks_sec_inner">
      <h2 class="thanks_sec_title">郵送申込が完了しました</h2>
      <p class="thanks_sec_lead">
        この度はご申込いただき、誠にありがとうございます。<br>
        ご登録のメールアドレスに受付完了のご連絡をお送りしました。<br>
        資料は順次郵送いたしますので、今しばらくお待ちください。
      </p>
      <p class="thanks_sec_lead">
